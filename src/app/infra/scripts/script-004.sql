...
((SELECT id from eleicao where nome = 'Eleição Municipal de Borá - Cargo Vereador'), (SELECT id from partido where sigla = 'PSD'));
...
INSERT INTO `totaliza`.`partido_eleicao` (`eleicao_id`, `partido_id`) VALUES ((SELECT id from eleicao where nome = 'Eleição Municipal de Borá - Cargo Vereador'), (SELECT id from partido where sigla = 'PT'));
INSERT INTO `totaliza`.`partido_eleicao` (`eleicao_id`, `partido_id`) VALUES ((SELECT id from eleicao where nome = 'Eleição Municipal de Borá - Cargo Vereador'), (SELECT id from partido where sigla = 'PSB'));
...
INSERT INTO `totaliza`.`partido_eleicao` (`eleicao_id`, `partido_id`) VALUES ((SELECT id from eleicao where nome = 'Eleição Municipal de Borá - Cargo Vereador'), (SELECT id from partido where sigla = 'PRB'));
INSERT INTO `totaliza`.`partido_eleicao` (`eleicao_id`, `partido_id`) VALUES ((SELECT id from eleicao where nome = 'Eleição Municipal de Borá - Cargo Vereador'), (SELECT id from partido where sigla = 'PV'));
INSERT INTO `totaliza`.`partido_eleicao` (`eleicao_id`, `partido_id`) VALUES ((SELECT id from eleicao where nome = 'Eleição Municipal de Borá - Cargo Vereador'), (SELECT id from partido where sigla = 'PSDB'));