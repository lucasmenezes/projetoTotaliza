...
function render(input, out, __component, component, state) {
  ...
  out.w(" </div></div></div></div><br><form" +
    ...
    " method=\"post\"><div class=\"text-right\"><button type=\"submit\" class=\"btn btn-danger btn-lg\">Totalizar</button></div></form></div></main><script src=\"/estatico/js/jquery-3.4.1.min.js\"></script><script src=\"/estatico/js/popper.min.js\"></script><script src=\"/estatico/js/bootstrap.min.js\"></script>");

  init_components_tag({}, out);

  await_reorderer_tag({}, out, __component, "135");
